...
namespace Miriot.Converters
{
    ...
    public class RelativeTimeConverter : IValueConverter
    {
        ...
        /// </summary>
        private static ResourceLoader TimeResources => ResourceLoader.GetForCurrentView();

        /// <summary>
        /// CultureInfo object using the user's preferred language list
        /// </summary>
        private static CultureInfo PreferredCulture => new CultureInfo(CurrentLanguageTag);

        /// <summary>
        /// Gets the current BCP-47 language from the user's language preference list
        /// </summary>
        private static string CurrentLanguageTag => ResourceManager.Current.DefaultContext.Languages[0].ToString();
